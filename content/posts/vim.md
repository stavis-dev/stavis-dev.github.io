...
title: "Комманды vim"
date: "2022-04-13"
description: "Vim vi nvim как совладать. (в процессе обучения - контент меняется регулярно)"
tags: ["vim", "education"]
...
cover:
    hidden: true
    image: "https://jenyay.net/uploads/Programming/VimPlugins2/gitgutter_3.png"
...
В vim и его форках - клонах, есть 3 + 1 режима: 
...
- Настройки nvim видео с канал [Диджитализируй](https://www.youtube.com/watch?v=PA7zZNJXJEk)
