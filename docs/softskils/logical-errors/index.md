...
![Апелляция к авторитету](Appeal_to_Authority.png)
...
Когда некоторым людям не хватает логических аргументов.  
В ход часто могут пойти угрозы физической расправы, разумеется, без логических обоснований.
...
- Два зла образуют благо на [youtube-shorts](https://youtube.com/shorts/zTtGA-MNfsI)
