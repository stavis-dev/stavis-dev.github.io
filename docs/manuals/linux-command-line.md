...
По умолчанию размер отображается в [гибибайтах[https://ru.wikipedia.org/wiki/Гибибайт]. Для отображения свободного места в гигабайтах (десятичное измерение) нужно спользовать ключ `-BG`
