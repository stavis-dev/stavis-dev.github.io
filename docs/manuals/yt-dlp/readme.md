...
Для общедоступных одиночных роликов `vk.com` скачивание такое же как и для `youtube.com`
...
Для скачивание приватных роликов, или тех, что открыты только для пользователя необходимо использовать `cookies` из браузера.  
А именно.

1. Залогиниться через браузер в `https://vk.com` к примеру это будет браузер `firefox`.
2. Перейти на страницу приватного видео или плейлиста, убедившись, что видео проигрывается в браузере, а плейлист отображается полностью. Например адрес приватного плейлиста будет `https://vk.com/video/playlist/-123456789_12`
